...
const copy = {
  nb: {
    ...
    projects: "Varneth Management Ness", projectTitle: "Prosjekter og utgivelser.", projectIntro: "Foretakets egne musikkprosjekter. Finn riktig prosjekt på Facebook.", projectLink: "Se prosjektet på Facebook", featuredLabel: "Utvalgt låt", featuredText: "Crown of Cracks fra Black Veil Hearts.", featuredLink: "Hør låten på Spotify", storyLabel: "Nytt prosjekt", storyTitle: "KI-storytelling musikkprosjekt", storyCaption: "Et nytt musikkprosjekt der sangene forteller historien.", storyAltOne: "KI-musikkillustrasjon med tittelen The Dark Romance", storyAltTwo: "KI-musikkillustrasjon med tittelen Kiss Me When the World Ends", storyAltThree: "Teaserbilde til KI-storytellingprosjektet The Dead Romance",
