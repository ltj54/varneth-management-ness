...
const copy = {
  nb: {
    ...
    genreLabel: "Musikalsk retning", genre: "Melodic Metalcore / Alternative Metal, med elementer av post-hardcore og moderne hardrock.",
    listen: "Utforsk musikken", contact: "Ta kontakt",
    projects: "Varneth Management Ness", projectTitle: "Prosjekter og utgivelser.", projectIntro: "Foretakets egne musikkprosjekter. Finn riktig prosjekt på Facebook.", projectLink: "Se prosjektet på Facebook", brokenVisualLabel: "Broken Veil – fiktivt KI-band", brokenStoryLink: "Les første fortelling om Broken Veil", brokenBook3Link: "Les bok 3 – Cruiset", brokenBook2Coming: "Bok 2 kommer – historien fortsetter.", brokenBandDescription: "HENNING – grunnlegger og tidligere management-CEO, nå gitarist og en av grunnleggerne av Broken Veil. EMMELY – tredjegenerasjons vokalist og nåværende vokalist i Broken Veil, datter av Henning og Karianne. KARIANNE – Hennings kone og nåværende management-CEO. MARA – andregenerasjons vokalist, nå reservegitarist og bandsjef. EMIL – trommeslager og bror til Emma, førstegenerasjons vokalist og medgrunnlegger av Broken Veil. Alt er fiktivt og introduserer KI-bandet Broken Veil.", upcomingLabel: "Ny Broken Veil-produksjon", upcomingTitle: "Ashes Before Dawn / After We Burn", upcomingText: "En ny produksjon med musikalsk inspirasjon fra Arch Enemy. Utgivelsesdatoen er foreløpig ikke bestemt. Følg Broken Veil på Facebook for oppdateringer.", upcomingLink: "Se siste nytt på Facebook", upcomingAltOne: "Broken Veil – Ashes Before Dawn, et forspill til After We Burn", upcomingAltTwo: "Broken Veil – After We Burn", featuredLabel: "Utvalgt låt", featuredText: "Crown of Cracks fra Black Veil Hearts.", featuredLink: "Hør låten på Spotify", storyLabel: "Nytt prosjekt", storyTitle: "KI-storytelling musikkprosjekt", storyCaption: "Et nytt musikkprosjekt der sangene forteller historien.", storyAltOne: "KI-musikkillustrasjon med tittelen The Dark Romance", storyAltTwo: "KI-musikkillustrasjon med tittelen Kiss Me When the World Ends", storyAltThree: "Teaserbilde til KI-storytellingprosjektet The Dead Romance",
    ...
    bio: "Henning er KI-komponist og driver med produksjon og utgivelse av KI-musikk. Gjennom Varneth Management Ness utvikler han egne prosjekter og tilbyr rådgivning innen KI-musikkproduksjon.", trainingTitle: "Relevant bakgrunn", training: ["Grunnkurs i AI engineering – pågående", "Grunnkurs i music management – pågående", "Grunnkurs i musikkproduksjon – pågående", "Egen produksjonserfaring: 2 album, 5 EP-er og 12 singler"],
  ...
  en: {
    ...
    genreLabel: "Musical direction", genre: "Melodic Metalcore / Alternative Metal, with elements of post-hardcore and modern hard rock.",
    listen: "Explore the music", contact: "Get in touch",
    projects: "Varneth Management Ness", projectTitle: "Projects and releases.", projectIntro: "The company’s original music projects. Find the right project on Facebook.", projectLink: "View project on Facebook", brokenVisualLabel: "Broken Veil – fictional AI band", brokenStoryLink: "Read the first Broken Veil story", brokenBook3Link: "Read book 3 – The Cruise", brokenBook2Coming: "Book 2 is coming – the story continues.", brokenBandDescription: "HENNING – founder and former management CEO, now guitarist and one of Broken Veil’s founders. EMMELY – third-generation vocalist and current Broken Veil vocalist, daughter of Henning and Karianne. KARIANNE – Henning’s wife and current management CEO. MARA – second-generation vocalist, now reserve guitarist and band leader. EMIL – drummer and brother of Emma, first-generation vocalist and co-founder of Broken Veil. Everything is fictional and introduces the AI band Broken Veil.", upcomingLabel: "New Broken Veil production", upcomingTitle: "Ashes Before Dawn / After We Burn", upcomingText: "A new production with musical inspiration from Arch Enemy. The release date has not yet been decided. Follow Broken Veil on Facebook for updates.", upcomingLink: "See the latest news on Facebook", upcomingAltOne: "Broken Veil – Ashes Before Dawn, a prelude to After We Burn", upcomingAltTwo: "Broken Veil – After We Burn", featuredLabel: "Featured track", featuredText: "Crown of Cracks by Black Veil Hearts.", featuredLink: "Listen on Spotify", storyLabel: "New project", storyTitle: "AI storytelling music project", storyCaption: "A new music project where the songs tell the story.", storyAltOne: "AI music artwork titled The Dark Romance", storyAltTwo: "AI music artwork titled Kiss Me When the World Ends", storyAltThree: "Teaser artwork for the AI storytelling project The Dead Romance",
    ...
    bio: "Henning is an AI composer working in AI music production and releases. Through Varneth Management Ness, he develops his own projects and offers consulting in AI music production.", trainingTitle: "Relevant background", training: ["Foundation course in AI engineering – in progress", "Foundation course in music management – in progress", "Foundation course in music production – in progress", "Independent production experience: 2 albums, 5 EPs and 12 singles"],
  ...
  return (
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-copy"><p className="eyebrow">{t.label}</p><h1>{t.title}<em>{t.italic}</em></h1><p className="intro">{t.intro}</p><p className="genre-line"><span>{t.genreLabel}</span>{t.genre}</p><div className="hero-actions"><a className="button" href="#musikk">{t.listen}<span aria-hidden="true">↘</span></a><a className="text-link" href="#kontakt">{t.contact} ↗</a></div></div>
      ...
      <section className="music section" id="musikk">
        ...
        <div className="project-grid">
          {[{ name: "Broken Veil", url: "https://www.facebook.com/share/14ktmModUdV/", logo: "broken-veil.png", width: 1536, height: 1024, className: "project-broken-veil" }, { name: "Black Veil Hearts", url: "https://www.facebook.com/share/1U9urN8ys5/", logo: "black-veil-hearts.png", width: 1254, height: 1254, className: "project-black-veil-hearts" }].map(({ name, url, logo, width, height, className }) => <a className={`project ${className}`} href={url} target="_blank" rel="noreferrer" key={name}><div className="project-art project-logo"><Image src={`${basePath}/${logo}`} alt={`${name} – ${language === "nb" ? "prosjektlogo" : "project logo"}`} width={width} height={height} sizes="(max-width: 600px) 90vw, 44vw" /></div><div className="project-content"><p className="eyebrow">{t.ai}</p><h3>{name}</h3><span className="project-link">{t.projectLink}<b aria-hidden="true">↗</b></span></div></a>)}
        </div>
        <figure className="project-feature-image"><Image src={`${basePath}/broken-veil-band.png`} alt={t.brokenVisualLabel} width={1374} height={1145} sizes="(max-width: 900px) 90vw, 70vw" /><figcaption>{t.brokenVisualLabel}</figcaption><a className="project-story-link" href={`${basePath}/broken-veil`}>{t.brokenStoryLink} <span aria-hidden="true">↗</span></a><a className="project-story-link" href={`${basePath}/broken-veil/book-3`}>{t.brokenBook3Link} <span aria-hidden="true">↗</span></a><p className="project-story-link project-story-link-muted">{t.brokenBook2Coming}</p></figure>
        <figure className="project-feature-image management-feature-image"><Image src={`${basePath}/broken-veil-management.png`} alt="Broken Veil sammen med managementet" width={1374} height={1145} sizes="(max-width: 900px) 90vw, 70vw" /><figcaption>Broken Veil sammen med managementet.</figcaption><p className="project-feature-copy">{t.brokenBandDescription}</p></figure>
        <section className="upcoming-production" aria-labelledby="upcoming-production-title">
          <div className="section-heading"><div><p className="eyebrow">{t.upcomingLabel}</p><h2 id="upcoming-production-title">{t.upcomingTitle}</h2></div><p>{t.upcomingText}</p></div>
          <div className="upcoming-production-grid"><figure><Image src={`${basePath}/broken-veil-ashes-before-dawn.png`} alt={t.upcomingAltOne} width={1254} height={1254} sizes="(max-width: 700px) 90vw, 45vw" /><figcaption>Ashes Before Dawn</figcaption></figure><figure><Image src={`${basePath}/broken-veil-after-we-burn.png`} alt={t.upcomingAltTwo} width={1254} height={1254} sizes="(max-width: 700px) 90vw, 45vw" /><figcaption>After We Burn</figcaption></figure></div>
          <a className="project-story-link upcoming-production-link" href="https://www.facebook.com/share/14ktmModUdV/" target="_blank" rel="noreferrer">{t.upcomingLink} <span aria-hidden="true">↗</span></a>
        </section>
      ...
      <section className="about section" id="henning"><div className="about-content-grid"><div className="about-copy"><p className="eyebrow">{t.human}</p><h2>{t.humanTitle}<br /><em>{t.humanLast}</em></h2><p className="bio">{t.bio}</p><div className="background-list"><p className="eyebrow">{t.trainingTitle}</p><ul>{t.training.map(item => <li key={item}>{item}</li>)}</ul></div><a className="facebook-icon-link" href="https://www.facebook.com/share/1WVwG43WTq/" target="_blank" rel="noreferrer" aria-label="Facebook: Varneth Management Ness"><span className="facebook-icon-crop"><Image src={`${basePath}/facebook-brand.png`} alt="" width={40} height={40} sizes="40px" /></span><span>{t.facebook}</span></a></div><figure className="about-illustration"><Image src={`${basePath}/about-ai.png`} alt={t.illustrationAlt} width={1536} height={1152} sizes="(max-width: 900px) 90vw, 45vw" /><figcaption>{t.illustrationCaption}</figcaption></figure></div></section>


      <aside className="inspiration section"><div><p className="eyebrow">{t.inspiration}</p><small>{t.inspirationNote}</small></div><div className="inspiration-links">{["Gravel N Bones", "Iron West", "Abdysall", "Arch Enemy"].map(name=><a href={search(name)} target="_blank" rel="noreferrer" key={name}>{name}<small>{t.inspirationLink} ↗</small></a>)}</div></aside>
